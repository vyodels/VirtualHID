...
final class KillSwitchTests: XCTestCase {
    ...
    func testPassiveLearningBuildsCompactMouseAndKeyboardGestureSamplesAutomatically() {
        ...
        XCTAssertEqual(published.count, 3, "focused movement samples are persisted automatically")
        XCTAssertEqual(published[2].source, "user-focused")
        ...
        XCTAssertEqual(published.count, 4, "focused click samples are persisted automatically")
        XCTAssertEqual(published[3].source, "user-focused")
