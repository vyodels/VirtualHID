...
public enum BrowserChromeOverlayDetector {
    public static func preflight(
        ...
        policy: BrowserChromeOverlayPolicy = .auto
        ...
        let blocked = best.confidence >= 0.65
        return BrowserChromeOverlayPreflight(
            ...
            evidence: best.evidence + ["targetArea=\(describe(targetRect))", "policy=\(policy.rawValue)", "policy.dismissSafe=\(policy == .force)"]
        )
    }
